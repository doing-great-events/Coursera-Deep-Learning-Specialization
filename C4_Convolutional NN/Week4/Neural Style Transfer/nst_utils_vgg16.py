...
def load_vgg_model(path):
    ...
    Here is the detailed configuration of the VGG model:
        ...
        15 is relu
        ##### not in vgg16 16 is conv3_4 (3, 3, 256, 256)
        ##### not in vgg16 17 is relu
        18 is maxpool
        ...
        24 is relu
        ##### not in vgg16 25 is conv4_4 (3, 3, 512, 512)
        ##### not in vgg16 26 is relu
        27 is maxpool
        ...
        33 is relu
        ##### not in vgg16 34 is conv5_4 (3, 3, 512, 512)
        ##### not in vgg16 35 is relu
        36 is maxpool
